...
func (s *Service) IssueAgentTeamsToken(ctx context.Context, requesterRole string, request biz.AgentTeamsTokenRequest) (*biz.AgentTeamsToken, error) {
	return s.user.IssueAgentTeamsToken(ctx, requesterRole, request)
}
