...
//     /etc/opskeeper-edge/bash-policy.yaml exists we merge it on top
...
// agent.
const DefaultPolicyOverridePath = "/etc/opskeeper-edge/bash-policy.yaml"
...
// /etc/opskeeper-edge/bash-policy.yaml).
