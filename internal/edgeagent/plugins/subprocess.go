...
//     NOT proxy bytes through opskeeper-edge — )
...
type SubprocessPlugin struct {
	...
	name         string
	binary       string                                             // /opt/opskeeper-edge/bin/promtail
	workDir      string                                             // /var/lib/opskeeper-edge/plugins/logs
...
// at /opt/opskeeper-edge/bin/<name>).
...
// future "tail subprocess output to opskeeper-edge structured log" if we
