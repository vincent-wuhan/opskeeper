...
// the opskeeper manager container's metrics endpoint already binds 9100
// via docker-proxy.
...
// New constructs the hostmetrics plugin. binDir is where opskeeper-edge
// looks for the bundled node_exporter binary (typically
// /usr/local/lib/opskeeper-edge); workDir is plugin scratch dir.
