...
type Registry struct {
	...
	externalBaseTools []basetool.BaseTool
...
func (r *Registry) AppendExternalBaseTool(tool basetool.BaseTool) {
	if tool != nil {
		r.externalBaseTools = append(r.externalBaseTools, tool)
	}
}
...
func NewRegistry(caller Caller, edges *edgebiz.Usecase, devices *devicebiz.Usecase,
	...
	// Read-only opskeeper business-data tools. query_edges + get_topology are
