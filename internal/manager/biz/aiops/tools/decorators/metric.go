...
// (记 opskeeper_tool_invocations_total).
...
// opskeeper_tool_invocations_total{name=..,result=success|error} and
// observes opskeeper_tool_duration_seconds{name=..} regardless of outcome.
