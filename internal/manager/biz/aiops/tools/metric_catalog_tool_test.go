...
func TestListMetricCatalogTool_FiltersAndReturnsSamples(t *testing.T) {
	pq := &fakePromQuerier{
		resp: &promquery.InstantResult{
			...
			Result: json.RawMessage(`[
				{"metric":{"__name__":"custom_queue_depth","device_id":"5","opskeeper_source":"custom:queue","job":"queue-exporter"},"value":[1,"2"]},
				{"metric":{"__name__":"custom_queue_depth","device_id":"5","opskeeper_source":"custom:queue","job":"queue-exporter","instance":"127.0.0.1:9100"},"value":[1,"3"]},
				{"metric":{"__name__":"http_requests_total","device_id":"5","job":"api"},"value":[1,"7"]},
				{"metric":{"__name__":"custom_queue_depth","device_id":"6","opskeeper_source":"custom:queue"},"value":[1,"11"]}
			]`),
		},
	}
	...
	if len(got.SampleLabels) == 0 || got.SampleLabels[0]["opskeeper_source"] != "custom:queue" {
		t.Fatalf("sample labels missing opskeeper_source: %#v", got.SampleLabels)
	}
}
	...
	pq := &fakePromQuerier{
		resp: &promquery.InstantResult{
			...
			Result: json.RawMessage(`[
				...
				{"metric":{"__name__":"mysql_global_status_threads_connected","device_id":"5","opskeeper_source":"db:mysql-1"},"value":[1,"1"]},
				{"metric":{"__name__":"mysql_global_variables_max_connections","device_id":"5","opskeeper_source":"db:mysql-1"},"value":[1,"1"]},
				{"metric":{"__name__":"redis_connected_clients","device_id":"5","opskeeper_source":"db:redis-1"},"value":[1,"1"]}
			]`),
		},
	}
	tool := NewListMetricCatalogTool(pq, slog.Default())
...
func TestListMetricCatalogTool_InstructsWhenBurnRateMetricsLackStatusLabel(t *testing.T) {
	pq := &fakePromQuerier{
		resp: &promquery.InstantResult{
			ResultType: "vector",
			Result: json.RawMessage(`[
				{"metric":{"__name__":"traces_spanmetrics_calls_total","service":"opskeeper-manager"},"value":[1,"33"]},
				{"metric":{"__name__":"traces_spanmetrics_latency_count","service":"opskeeper-manager"},"value":[1,"33"]}
			]`),
		},
	}
	tool := NewListMetricCatalogTool(pq, slog.Default())

	out, err := tool.InvokableRun(context.Background(), `{"query":"API 5xx burn rate for opskeeper-manager","prefixes":["http_","custom_","traces_spanmetrics_"],"max_metrics":10}`)
	if err != nil {
		t.Fatalf("InvokableRun: %v", err)
	}
	var resp MetricCatalogResponse
...
func TestListMetricCatalogTool_ReturnsDatabaseDimensionSamples(t *testing.T) {
	pq := &fakePromQuerier{
		resp: &promquery.InstantResult{
			ResultType: "vector",
			Result: json.RawMessage(`[
				{"metric":{"__name__":"mongodb_ss_connections","device_id":"2","opskeeper_source":"db:mongo-test","conn_type":"active"},"value":[1,"1"]},
				{"metric":{"__name__":"mongodb_ss_connections","device_id":"2","opskeeper_source":"db:mongo-test","conn_type":"available"},"value":[1,"1"]},
				{"metric":{"__name__":"mongodb_ss_connections","device_id":"2","opskeeper_source":"db:mongo-test","conn_type":"awaitingTopologyChanges"},"value":[1,"1"]},
				{"metric":{"__name__":"mongodb_ss_connections","device_id":"2","opskeeper_source":"db:mongo-test","conn_type":"current"},"value":[1,"1"]},
				{"metric":{"__name__":"mongodb_ss_globalLock_currentQueue","device_id":"2","opskeeper_source":"db:mongo-test","count_type":"total"},"value":[1,"1"]}
			]`),
		},
	}
	tool := NewListMetricCatalogTool(pq, slog.Default())
...
func TestListMetricCatalogTool_RanksPostgresNumBackendsForConnections(t *testing.T) {
	pq := &fakePromQuerier{
		resp: &promquery.InstantResult{
			ResultType: "vector",
			Result: json.RawMessage(`[
				{"metric":{"__name__":"pg_settings_log_connections","device_id":"2","opskeeper_source":"db:pg-test"},"value":[1,"1"]},
				{"metric":{"__name__":"pg_stat_database_numbackends","device_id":"2","opskeeper_source":"db:pg-test","datname":"postgres"},"value":[1,"1"]},
				{"metric":{"__name__":"pg_settings_max_connections","device_id":"2","opskeeper_source":"db:pg-test"},"value":[1,"1"]}
			]`),
		},
	}
	tool := NewListMetricCatalogTool(pq, slog.Default())
...
func TestListMetricCatalogTool_RanksPostgresCacheHitPairTogether(t *testing.T) {
	pq := &fakePromQuerier{
		resp: &promquery.InstantResult{
			ResultType: "vector",
			Result: json.RawMessage(`[
				{"metric":{"__name__":"pg_settings_effective_cache_size_bytes","device_id":"2","opskeeper_source":"db:pg-test"},"value":[1,"1"]},
				{"metric":{"__name__":"pg_settings_debug_discard_caches","device_id":"2","opskeeper_source":"db:pg-test"},"value":[1,"1"]},
				{"metric":{"__name__":"pg_stat_database_blks_hit","device_id":"2","opskeeper_source":"db:pg-test","datname":"postgres"},"value":[1,"1"]},
				{"metric":{"__name__":"pg_stat_database_blks_read","device_id":"2","opskeeper_source":"db:pg-test","datname":"postgres"},"value":[1,"1"]},
				{"metric":{"__name__":"pg_statio_user_tables_heap_blocks_hit","device_id":"2","opskeeper_source":"db:pg-test"},"value":[1,"1"]}
			]`),
		},
	}
	tool := NewListMetricCatalogTool(pq, slog.Default())
