...
// WrapBaseTool adapts an opskeeper basetool.BaseTool to eino's
...
// einoInvokeOptKey is the internal carrier for opskeeper InvokeOptions
...
// (terminates the whole invoke + SSE stream); opskeeper's invariant is
