...
// conversation (group chat / DM / reply thread) to an opskeeper
...
// for reply threads; DingTalk conversationId) to one opskeeper
...
type ImThread struct {
	...
	OpskeeperSessionID string `gorm:"column:opskeeper_session_id;size:128;not null;index:idx_session"`
