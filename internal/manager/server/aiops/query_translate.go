...
- opskeeper 标签：device_id (string数字), service, level, unit (systemd unit), filename, host
...
- 用 opskeeper 已有的 metric：node_cpu_seconds_total, node_memory_MemAvailable_bytes,
  node_filesystem_avail_bytes, node_load1, node_network_*_bytes_total,
  node_disk_*_bytes_total, host_cpu_pct, host_mem_pct, host_disk_used_pct, opskeeper_edge_status
