...
func TestChatServer429(t *testing.T) {
	...
	if got := counterValue(t, reg, "opskeeper_llm_requests_total", "gpt-4o", "error"); got < 1 {
...
func TestChatBudgetShortCircuits(t *testing.T) {
	...
	if got := counterValue(t, reg, "opskeeper_llm_requests_total", "gpt-4o", "budget_exceeded"); got != 1 {
...
// (https://github.com/vincent-wuhan/opskeeper/pull/54): an operator points the
