...
// Streamable HTTP — the narrow slice opskeeper needs as an MCP *client*
...
// ProtocolVersion is the MCP revision opskeeper advertises at initialize.
...
func (c *Client) Initialize(ctx context.Context) error {
	params := map[string]any{
		...
		"clientInfo":      map[string]any{"name": "opskeeper", "version": "1"},
	}
