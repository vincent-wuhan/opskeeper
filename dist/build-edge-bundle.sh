...
ENTRIES=(
  "opskeeper-edge            0755 /usr/local/bin/opskeeper-edge                            $BIN_DIR/opskeeper-edge"
  "node_exporter          0755 /usr/local/lib/opskeeper-edge/node_exporter              $BIN_DIR/node_exporter"
  "process_exporter       0755 /usr/local/lib/opskeeper-edge/process_exporter           $BIN_DIR/process_exporter"
  "mysqld_exporter        0755 /usr/local/lib/opskeeper-edge/mysqld_exporter            $BIN_DIR/mysqld_exporter"
  "postgres_exporter      0755 /usr/local/lib/opskeeper-edge/postgres_exporter          $BIN_DIR/postgres_exporter"
  "redis_exporter         0755 /usr/local/lib/opskeeper-edge/redis_exporter             $BIN_DIR/redis_exporter"
  "mongodb_exporter       0755 /usr/local/lib/opskeeper-edge/mongodb_exporter           $BIN_DIR/mongodb_exporter"
  "promtail               0755 /usr/local/lib/opskeeper-edge/promtail                   $BIN_DIR/promtail"
  "otelcol-contrib        0755 /usr/local/lib/opskeeper-edge/otelcol-contrib            $BIN_DIR/otelcol-contrib"
  "apply-pending-upgrade.sh 0755 /usr/local/lib/opskeeper-edge/apply-pending-upgrade.sh $APPLY_SCRIPT"
)
