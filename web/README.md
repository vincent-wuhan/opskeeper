...
Single-page React + TypeScript app for opskeeper AIOps. Production build is a static
...
localStorage under `opskeeper.auth`. On any 401, the client clears the session and
