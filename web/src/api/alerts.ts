...
const SCOPE_HINT_ZH = {
  ...
  monitoring_pipeline: 'OpsKeeper 自我观测（manager / 通知投递 / Prom write 健康）',
} as const;
const SCOPE_HINT_EN = {
  host: 'One incident per host; evaluator groups by device',
  global: 'One incident per query; aggregated across hosts',
  monitoring_pipeline: 'OpsKeeper self-observability (manager / notify delivery / Prom write health)',
} as const;
