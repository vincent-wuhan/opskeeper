...
//
// When the future `builtin://vault` auto-loader replaces these seeds
...
// — the current builtin://vault layout). Each entry carries both
...
const KNOWLEDGE_PATH_SEGMENTS: Record<string, { zh: string; en: string }> = {
  // builtin://vault current English-named tree
