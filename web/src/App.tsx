...
const ClosedLoopTimelinePage = lazy(() => import('@/pages/Incidents/ClosedLoopTimeline'));
const ChatDrawerPage = lazy(() => import('@/pages/Incidents/ChatDrawer').then(m => ({ default: m.ChatDrawerPage })));
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/incidents/:id/loop" element={<ClosedLoopTimelinePage />} />
        <Route path="/incidents/:id/diagnose" element={<ChatDrawerPage />} />
