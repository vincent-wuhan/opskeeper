...
import { OpskeeperLogo } from '@/components/OpskeeperLogo';

const GITHUB_URL = 'https://github.com/vincent-wuhan/opskeeper';
const LICENSE = 'AGPL-3.0-only';
const LICENSE_URL = 'https://github.com/vincent-wuhan/opskeeper/blob/main/LICENSE';
    ...
    <div className="mx-auto max-w-2xl">
      <div className="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-800/60 dark:bg-zinc-900/40">
        <div className="flex items-center gap-3">
          <OpskeeperLogo size={44} className="shrink-0" />
          <div>
            <h2 className="text-base font-semibold text-zinc-900 dark:text-zinc-100">OpsKeeper</h2>
        ...
        <dl className="mt-5 divide-y divide-zinc-200 text-sm dark:divide-zinc-800/60">
          ...
          <Row icon={<Github size={14} />} label={tr('源码', 'Source')}>
            ...
            >
              github.com/vincent-wuhan/opskeeper <ExternalLink size={12} />
            </a>
          </Row>
