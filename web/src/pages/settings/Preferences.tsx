  ...
  return (
    <div className="space-y-4">
      ...
      <section className="rounded-xl border border-zinc-800 bg-zinc-900/40 p-5">
        ...
        <p className="mb-3 text-xs text-zinc-500">
          {tr(
            '选择一种品牌色作为高亮 / CTA / 当前选中态。来源自 OpsKeeper logo 的两束渐变。',
            'Pick a brand color for highlights, primary CTAs, and active state. Drawn from the two gradients in the OpsKeeper logo.',
          )}
        </p>
